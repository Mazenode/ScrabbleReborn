...
public class Grille extends JPanel {
    private static ArrayList<Case> liste = new ArrayList<>();
    ...
    public Grille() {
        ...
        for (int j = 0; j < SIZE * SIZE; j++) { // permet de mettre les 100 bouttons
            ...
            if(j == 0 || j == 7 || j == 14 || j == 105 || j == 119 || j == 210 || j == 217 || j == 224 )
                ...
                liste.get(j).getButton().setBackground(new Color(61,191,238));
            }
            else if(j == 16 || j == 28 || j == 32|| j == 42|| j == 48|| j == 56|| j == 64|| j == 70||j == 112 || j == 154|| j == 160|| j == 168|| j == 176|| j == 182|| j == 192 || j== 196|| j == 192|| j == 208){
                liste.get(j).getButton().setBackground(new Color(222,135,184));
            }
            else if(j == 20 || j == 24 || j == 76|| j == 80|| j == 84|| j == 88|| j == 136|| j == 140||j == 144 || j == 148|| j == 200|| j == 204){
                liste.get(j).getButton().setBackground(new Color(56,84,164));
            }
            else{
                liste.get(j).getButton().setBackground(new Color(45,182,113));
            }
